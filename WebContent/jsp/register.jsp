		...
		<s:form action="register" cssClass="form-horizontal" method="post">
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield type="email" name="register_email" id="register_email" size="20" placeholder="E-mail" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:password name="register_password" id="register_password" size="20" placeholder="Password" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">										
					...
					<s:password name="register_password2" id="register_password2" size="20" placeholder="Password (confirm)" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield name="register_displayName" id="register_displayName" placeholder="Display name" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield name="register_firstName" id="register_firstName" placeholder="First name" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield name="register_lastName" id="register_lastName" placeholder="Last name" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
							...
							<s:textfield name="register_birthdate" id="register_birthdate" cssClass="inputDate form-control" value="01-01-1980" size="30" />								
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield name="register_street" id="register_street" placeholder="Street" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield name="register_houseNumber" id="register_houseNumber" placeholder="Housenumber" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield pattern="[0-9]{4}[ ]?[a-zA-Z]{2}" name="register_postalCode" id="register_postalCode" placeholder="Postal code" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<s:textfield name="register_city" id="register_city" placeholder="City" size="20" cssClass="form-control" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-12">
